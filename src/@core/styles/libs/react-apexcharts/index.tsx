...
const ApexChartWrapper = styled('div')(({ theme }) => ({
  '& .apexcharts-canvas': {
    ...
    '& .apexcharts-xaxistooltip': {
      borderColor: theme.palette.divider,
      background: theme.palette.mode === 'light' ? theme.palette.grey[50] : '#64777a',
      '&:after': {
        borderBottomColor: theme.palette.mode === 'light' ? theme.palette.grey[50] : '#64777a'
      },
      '&:before': {
    ...
    '& .apexcharts-yaxistooltip': {
      ...
      background: theme.palette.mode === 'light' ? theme.palette.grey[50] : '#64777a',
      '&:after': {
        borderLeftColor: theme.palette.mode === 'light' ? theme.palette.grey[50] : '#64777a'
      },
      '&:before': {
